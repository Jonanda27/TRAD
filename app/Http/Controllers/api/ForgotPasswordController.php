...
class ForgotPasswordController extends Controller
{
    public function sendOtp(Request $request)
    {
        ...
        $user = NewUser::where('userID', $request->userID)->where('phone', $request->phone)->first();
    ...
    public function verifyOtp(Request $request){
        ...
        $user = NewUser::where('phone', $request->phone)->where('otp', $request->otp)->first();
    ...
    public function resetPassword(Request $request)
    {
        ...
        // Cari user berdasarkan nomor telepon dan OTP
        $user = NewUser::where('no_hp', $request->no_hp)->where('otp', $request->otp)->first();
