...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: RiwayatTransaksiPembeli(idUser: userId,),
    );
  }
}
...
class RiwayatTransaksiPembeli extends StatefulWidget {
  ...
  RiwayatTransaksiPembeli({required this.idUser});

  @override
  _RiwayatTransaksiPembeliState createState() => _RiwayatTransaksiPembeliState();
}
...
void initState() {
  super.initState();
  _storeProfile = serviceKasir.getRiwayatTransaksi(widget.idUser.toString());
}
  ...
  builder: (context, snapshot) {
    if (snapshot.connectionState == ConnectionState.waiting) {
      ...
      final transaksiList = snapshot.data!['data'] as List<dynamic>;
