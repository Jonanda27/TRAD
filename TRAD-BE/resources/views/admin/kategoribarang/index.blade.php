...
<div class="container-fluid pt-4 px-4">
    <div>
        <div class="bg-secondary rounded h-100 p-4">
            ...
            <a href="/admin/kategoribarang/create">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    @foreach($kategori_barang_array as $item)
                    <tr>
                        <th scope="row">1</th>
                        <td>{{$item->nama}}</td>
                        <td>
                        ...
                        <div>
                            <td class="text-center">
                                <button class="border-0 bg-transparent">
                                    <a href="/admin/kategoribarang/{{ $item->id }}/edit">
                                        <i class="fas fa-edit text-primary"></i>
                                    </a>
                                </button>
                            </td>
                            <td class="text-center">
                                <form action="/admin/kategoribarang/{{ $item->id }}" method="POST">
                                    @csrf
                                    @method("DELETE")
            ...
            <div class="p-3 mx-5 pagination_index">
                {{$kategori_barang_array->links('pagination::bootstrap-5')}}
            </div>
        </div>
    </div>
</div>
